...
mkdir /home/git-sources && cd /home/git-sources && git clone https://github.com/JiaoXianjun/LTE-Cell-Scanner && cd /home/git-sources/LTE-Cell-Scanner && mkdir build && cd build && cmake ../ -DUSE_HACKRF=1 && make
